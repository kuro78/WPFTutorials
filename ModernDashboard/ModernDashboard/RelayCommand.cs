...
namespace ModernDashboard
{
    ...
    public class RelayCommand : ICommand 
    {
        ...
        /// This ensures that the WPF commanding infrastructure asks all RelayCommand objects if they can execute wherever
        ...
        public bool CanExecute(object paramreter)
        {
            return canExecute == null || canExecute(paramreter);
        }
